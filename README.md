...
- [You don&#39;t need importProvidersFrom with Angular Material](https://dev.to/this-is-angular/you-dont-need-importprovidersfrom-with-angular-material-3nih)
- [Laravel API Tutorial: Build, Document, and Secure a REST API](https://dev.to/zuplo/laravel-api-tutorial-build-document-and-secure-a-rest-api-4j83)
- [Create a Server Driven CLI from your REST API](https://dev.to/zuplo/create-a-server-driven-cli-from-your-rest-api-3p29)
<!-- BLOG-POST-LIST:END -->
